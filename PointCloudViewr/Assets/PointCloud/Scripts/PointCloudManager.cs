...
public class PointCloudManager : MonoBehaviour {
	...
	void loadPointCloud(){
		...
		if(File.Exists(Application.dataPath + "/Resources/Binary/"+dataPath))
	...
	IEnumerator loadOFF(string dPath){
		...
		// Read file
		FileStream sr = new FileStream (Application.dataPath + "/Resources/Binary/" + dataPath, FileMode.Open);
		//sr.ReadLine (); // OFF
